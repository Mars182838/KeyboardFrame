...
- (instancetype)initWithTextField:(UITextField *)textField {
    if (self = [super init]) {
        ...
        self.verify = true;
        self.backgroundColor = [UIColor colorWithRed:236/255.0 green:236/255.0 blue:238/255.0 alpha:1];
...
- (void)setupKeyBoard {
    ...
    for (int i=0; i< 9; i++) {
        ...
        button.backgroundColor = [UIColor colorWithRed:246/255.0 green:246/255.0 blue:248/255.0 alpha:1];
...
//    [dotButton setTitle:@"0" forState:UIControlStateNormal];
//    dotButton.tag = 0;
//    [self addSubview:dotButton];
//    self.dotButton = dotButton;
    
    UIButton *zeroButton = [UIButton buttonWithType:UIButtonTypeSystem];
    zeroButton.frame = CGRectMake(0,60*3+3, keyboardScreenWidth/4-1, 60);
    zeroButton.backgroundColor = [UIColor colorWithRed:246/255.0 green:246/255.0 blue:248/255.0 alpha:1];
    ...
    minusButton.frame=CGRectMake(keyboardScreenWidth/4+space,60*3+3, 2*(keyboardScreenWidth/4)-2, 60);
    minusButton.backgroundColor = [UIColor colorWithRed:246/255.0 green:246/255.0 blue:248/255.0 alpha:1];
    [minusButton setImage:[UIImage imageNamed:@"PGNumberKeyboard.bundle/resign.png"] forState:UIControlStateNormal];
    minusButton.tag=12;
    ...
    deleteButton.backgroundColor = [UIColor colorWithRed:246/255.0 green:246/255.0 blue:248/255.0 alpha:1];
    ...
    deleteImage.image=[UIImage imageNamed:@"PGNumberKeyboard.bundle/delete.png"];
    ...
    confirmbutton.backgroundColor = [UIColor colorWithRed:65/255.0 green:128/255.0 blue:233/255.0 alpha:1];
    [confirmbutton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [confirmbutton setTitleColor:[UIColor colorWithRed:125/255.0 green:168/255.0 blue:240/255.0 alpha:1] forState:UIControlStateDisabled];
